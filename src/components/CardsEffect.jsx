...
function CardsEffect({ title, description, color, icon, image, key }) {
  return (
    <div className="group relative cursor-pointer overflow-hidden bg-white px-6 pt-10 pb-8 ring-1 ring-gray-900/5 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl sm:mx-auto sm:max-w-sm sm:rounded-lg sm:px-10 h-full ">
      ...
      <div className="relative z-10 mx-auto max-w-md flex flex-col items-center justify-center text-center ">
        ...
        <div className="flex-1 flex flex-col justify-between">
          <div className="space-y-6 text-base leading-7 text-gray-600 transition-all duration-300 group-hover:text-white/90 font-bold">
            <p>{title}</p>
          </div>
