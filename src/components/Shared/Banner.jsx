...
function Banner({ title, description }) {
  return (
    <div class="text-center">
      <ul class="breadcrumb inline-flex h-8 items-center justify-center space-x-2 rounded-3xl bg-gray-100 px-4 py-2  ">
        <li class="leading-none text-dark">
          <Link class="inline-flex items-center text-pink-600" to="/">
            <svg
              class="mr-1.5"
              width="15"
              height="15"
            ...
            <span class="leading-none  font-light lg:text-xl">Inicio</span>
          </Link>
        </li>
        <li class="leading-none text-dark">
          <span class="leading-none  font-light lg:text-xl">/ {title}</span>
        </li>
      </ul>
    </div>
  );
