    ...
    <footer class="bg-gray-100 ">
      <div class="max-w-screen-xl px-4 py-8 mx-auto  lg:px-6 ">
        <div class="flex flex-col md:flex-row sm:items-center justify-center md:justify-between ">
          ...
          >
            <span className="self-center text-2xl font-semibold whitespace-nowrap text-gray-800  lg:text-xl">
              Detalles y Floreria El Regalo Ideal
            </span>
          </a>
          <ul className="flex flex-wrap justify-center items-center font-light lg:text-xl  text-gray-700 ">
        ...
        <div className="flex flex-col md:flex-row items-center  justify-center md:justify-between  ">
          <span className="font-light lg:text-lg text-gray-500 sm:text-center dark:text-gray-700  flex flex-row justify-center md:mb-0 mb-5 ">
            © 2024
            ...
            {RedesData.map((item, index) => {
              return (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className=" hover:text-gray-900 text-gray-600  px-2 py-1 font-light lg:text-xl"
                  key={index}
                >
